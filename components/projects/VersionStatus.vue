                ...
                <v-chip density="compact" rounded="xs" elevation="1" :class="chipStatus">
                    ...
                    <v-bottom-sheet>
                        ...
                        <v-card class="pa-4 pb-10">
                            ...
                            <v-card-text>
                                The status displayed here indicates the status of the curernt version.  Therefore a status of 'Complete' doesn't indicate that there will be no future work on this project.  Additionally, the version displayed may not yet be publicly available if the project is 'In Progress'.                        
                            </v-card-text>
                        </v-card>
                    </v-bottom-sheet>
                </v-chip>
